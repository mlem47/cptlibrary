...
class Plugin_Name {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('manage_cpt_books_posts_custom_column', $plugin_admin, 'cpt_custom_books_columns', 10, 4  );
		
		//meta-boxes for cpt's books
		$this->loader->add_action('add_meta_boxes', $plugin_admin, 'cpt_books_status');

		//meta-box save for cpt auftrag
		$this->loader->add_action('save_post', $plugin_admin, 'cpt_save_books_status_data');

		//meta-boxes for cpt's auftrag
